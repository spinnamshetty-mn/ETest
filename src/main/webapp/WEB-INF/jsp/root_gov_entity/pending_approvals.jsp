  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="pending_approvals"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm"> Pending Approvals</span></a></li>
    ...
    <table id="find_and_update_request">
    	...
    	<td>
			...
			<select name="gov_request_update" id="gov_request_update">
    	...
    	<td> <button name="getbutton" type="submit" id="getbutton" value= ${request_list.govId} > Submit </button></td>
